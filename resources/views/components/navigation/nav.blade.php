...
<header class="py-2" x-data="{ open: false }">
    <nav class="bg-primary mx-auto flex items-center justify-between p-2 rounded-full" aria-label="Global">
        ...
        <div class="hidden gap-2 lg:flex lg:flex-1 lg:mr-10 lg:justify-end">
            <x-navigation.nav_link href="#service">Services</x-navigation.nav_link>
            <x-navigation.nav_link href="#project">Projects</x-navigation.nav_link>
            <x-navigation.nav_link href="#contact">Contact Us</x-navigation.nav_link>
            <x-navigation.nav_link href="#contact">Get in Touch</x-navigation.nav_link>
        </div>
    </nav>
    <div role="dialog" aria-modal="true" x-show="open" style="display: none">
