<div>
    ...
    <div class="flex mb-4">
        <a href="{{route('project.create')}}">
            <button class="btn btn-outline btn-success " type="button">Add project</button>
        </a>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr class="hover">
                ...
                <td>{{ count($project->assets) }}</td>
                <td>{{ $project->description }}</td>
                <td class="flex gap-2">
                    <a href="{{ route('project.edit', $project->uuid) }}">
                    ...
                    <a href="{{ route('project.destroy', $project->uuid) }}">
