<div>
    ...
    <div class="flex mb-4">
        <a href="{{route('service.create')}}">
            <button class="btn btn-outline btn-success " type="button">Add Service</button>
        </a>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr class="hover">
                ...
                <td>{{ $service->name }}</td>
                <td>{{ Str::ucfirst($service->type) }}</td>
                <td>{{ $service->description }}</td>
                <td class="flex gap-2">
                    <a href="{{ route('service.edit', $service->uuid) }}">
                    ...
                    <a href="{{ route('service.destroy', $service->uuid) }}">
